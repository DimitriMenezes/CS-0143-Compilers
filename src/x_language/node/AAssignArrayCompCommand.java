...
public final class AAssignArrayCompCommand extends PCommand
{
    private TId _id_;
    private PArrayComp _arrayComp_;

    public AAssignArrayCompCommand()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAssignArrayCompCommand(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAAssignArrayCompCommand(this);
    }
