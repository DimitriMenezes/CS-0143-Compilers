...
public final class AFunctionCallCommand extends PCommand
{
    private PFunctionCall _functionCall_;

    public AFunctionCallCommand()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFunctionCallCommand(
    ...
    {
        ((Analysis) sw).caseAFunctionCallCommand(this);
    }
